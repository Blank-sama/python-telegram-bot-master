...
from TeleGenic import Chat as TGChat
from TeleGenic import Message, MessageEntity, Update
from TeleGenic import User as TGUser
from TeleGenic.utils.types import SLT as SCT
FilterDataDict = Dict[str, list]
