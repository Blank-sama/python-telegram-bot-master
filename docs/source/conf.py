...
release = '7.0'  # telegram.__version__
...
# of the sidebar.
html_logo = 'Telegenic.png'

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = 'Telegenicic.ico'
...
htmlhelp_basename = 'TeleGenic-Docs'
...
latex_documents = [
  (master_doc, 'TeleGenic.tex', u'TeleGenic Documentation',
   author, 'manual'),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
latex_logo = 'Telegenic.png'
...
man_pages = [
    (master_doc, 'TeleGenic', u'TeleGenic Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'TeleGenic', u'TeleGenci Documentation',
   author, 'TeleGenic', "We have made you a wrapper you can't refuse",
   'Miscellaneous'),
]
